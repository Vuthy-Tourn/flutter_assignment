...
class _SignUpPageState extends State<SignUpPage> {
  ...
  InputDecoration _buildInputDecoration({
    ...
    return InputDecoration(
      ...
      filled: true,
      // Updated to withValues to fix your deprecation warning
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: _buildInputDecoration(hintText: "example@gmail.com", icon: Icons.email_outlined),
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text("Or login with", style: TextStyle(color: Colors.grey, fontSize: 14)),
                          ),
                          Expanded(child: Divider(color: Colors.grey.shade300)),
                        ],
                      ),
